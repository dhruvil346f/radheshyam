...
if ( ! function_exists( 'corporate_key_is_featured_slider_active' ) ) :
	 ...
	 */
	function corporate_key_is_featured_slider_active( $control ) {
...
if ( ! function_exists( 'corporate_key_is_featured_page_slider_active' ) ) :
	 ...
	 * @return bool Whether the control is active to the current preview.
	 */
	function corporate_key_is_featured_page_slider_active( $control ) {
