...
function corporate_key_scripts() {
	...
	wp_enqueue_style( 'corporate-key-style', get_stylesheet_uri(), array(), '2.0.2' );
	...
	wp_enqueue_script( 'corporate-key-custom', get_template_directory_uri() . '/js/custom' . $min . '.js', array( 'jquery' ), '2.0.2', true );
...
function corporate_key_admin_scripts( $hook ) {
	...
	if ( 'widgets.php' === $hook ) {
	    wp_enqueue_media();
		wp_enqueue_style( 'corporate-key-widgets', get_template_directory_uri() . '/css/widgets' . $min . '.css', array(), '2.0.2' );
		wp_enqueue_script( 'corporate-key-widgets', get_template_directory_uri() . '/js/widgets' . $min . '.js', array( 'jquery' ), '2.0.2', true );
	}
