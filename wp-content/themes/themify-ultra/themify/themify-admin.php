	...
	<div id="content">
		...
		<div id="update-check" class="maintab">
			...
			<div id="update-main" class="subtab update-main">
				<?php if ( ! is_plugin_active( 'themify-updater/themify-updater.php' ) ) : ?>
					<div class="note">
						<?php printf( __( 'To update theme automatically, please follow this documentation to install <a href="%s" target="_blank">Themify Updater</a>.', 'themify' ), 'https://themify.me/docs/themify-updater-documentation' ); ?>
					</div>
				<?php endif; ?>

				<?php themify_check_version( 'tab' ); ?>
			</div>
		</div>
		<!--/update theme/framework tab -->
