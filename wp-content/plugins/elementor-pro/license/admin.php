...
class Admin {
	...
	public static function get_license_key() {
		return 'fb451f05958872E193feb37a405a84be';
		
	}

	public static function set_license_key( $license_key ) {
		return update_option( 'elementor_pro_license_key', 'fb451f05958872E193feb37a405a84be' );
	}

	public function action_activate_license() {
		check_admin_referer( 'elementor-pro-license' );

		$license_key = 'fb451f05958872E193feb37a405a84be';
